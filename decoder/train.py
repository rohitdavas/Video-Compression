...
for temp in nets:
  print(temp)
if unet is not None:
  print("unet is being used\n. model saved in file. see summary from there") 
print("*"*10)
...
while True:
    ...
    for batch, (crops, ctx_frames, _) in enumerate(train_loader):
        if count_debug == 0:
          print("*"*10)
          print("type of crops: ", type(crops))
          print("size of crops: ", len(crops))
          print("size of a crop ", crops[0].size())
          print("*"*10)
        ...
        # Forward U-net. used only when video compression mode is open
        #else image compression mode
        if args.v_compress:
        ...
        if count_debug == 0:
          ...
          print("frame1: ", frame1.size())
          print("frame2: ", frame2.size())
          print("*"*10)
        ...
        for _ in range(args.iterations):
            ...
            if count_debug == 0:
              ...
              print("binarizer output shape: ", codes.shape)
              print("decode output shape: ", output.shape)
              print("*"*10)
              count_debug += 1
